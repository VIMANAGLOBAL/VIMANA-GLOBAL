...
public class CertificateRequestData {
    ...
    private static Logger log = LoggerFactory.getLogger(CertificateRequestData.class);
    private CertExtensionsGenerator attrGen;

    private X500Name subject;
    private Extensions extensions;
    
    private Map<String, String> certDataMap = new HashMap<>();
    ...
    public void processCertData(boolean allowSertSign) throws CryptoNotValidException, IOException {
        ...
        try {
            attrGen.createDefaultExtensions(allowSertSign);
            extensions = attrGen.generate();        
        } catch (IOException ex) {
            log.error("Excetion inside of extension generator",ex);
        }
    }
  ...
  //      certDataMap.put("attribute.subjaltnames.registeredid","");    
    ...
    public final void emptyParamMapForPerson() {
        ...
        certDataMap.put(SUBJ_PRFX + "UID", ""); //LDAP user Id or entity Id
        //This attribute is fixed for cert type
        certDataMap.put("attribute.KEY_PURPOSES", "personal");
 ...
 //       certDataMap.put(SUBJ_PRFX + "UNIQUE_IDENTIFIER", ""); //naming attribute from X520name
        ...
        certDataMap.put(SUBJ_PRFX + "UID", ""); //LDAP user Id or entity Id
        //This attribute is fixed for cert type
        certDataMap.put("attribute.KEY_PURPOSES", "softsign");
    }
    ...
    public void setSubjectAttribute(String name, String value){
        ...
        if(!rname.isEmpty()){            
            ...
            log.warn("Attribute is not suppoeted: {}", name);
        }
    }
