...
public class Main {
    ...
    public static void main(String[] argv) {
        ...
        JCommander jc = JCommander.newBuilder()
                ...
                .build();
        jc.setProgramName("vimryptoutils");
        try {
            jc.parse(argv);
        ...
        if (args.debug) {
            LogManager.getLogger("io.vimana").setLevel(org.apache.log4j.Level.DEBUG);
            log.debug("Current disrectory: " + System.getProperty("user.dir"));
        } else {
            LogManager.getLogger("io.vimana").setLevel(org.apache.log4j.Level.ERROR);
        }
