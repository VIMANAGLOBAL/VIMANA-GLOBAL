...
// import { CryptoEngine, getCrypto, getAlgorithmParameters, setEngine, AttributeTypeAndValue } from 'pkijs';

// import { setEngine } from 'pkijs';

let certificateBuffer = new ArrayBuffer(0); // ArrayBuffer with loaded or created CERT^M
let privateKeyBuffer = new ArrayBuffer(0);
//let trustedCertificates = []; // Array of root certificates from "CA Bundle"^M
//const intermadiateCertificates = []; // Array of intermediate certificates^M
// const crls = [];
