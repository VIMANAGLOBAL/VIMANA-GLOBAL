...
class Certificate {
    public:
        virtual std::vector<uint8_t> getEncoded()=0;
        virtual void verify(PublicKey& key)=0;
};
...
public:
   ...
   virtual void checkValidity() = 0;
     ...
     * @see #checkValidity()
     */
    virtual void checkValidity(long date) = 0;
       // throws CertificateExpiredException, CertificateNotYetValidException;
     ...
     */
    virtual std::vector<uint8_t> getSerialNumber()=0;
     ...
     */
    virtual std::string getIssuerDN()=0;
     ...
     */
    virtual std::string getSubjectDN()=0;
     ...
     */
    virtual std::string getSigAlgName()=0;
     ...
     */
    virtual std::string getSigAlgOID()=0;
     ...
     */
    virtual std::vector<uint8_t> getSigAlgParams()=0;
...
//    }
     ...
     */
    virtual int getBasicConstraints()=0;
