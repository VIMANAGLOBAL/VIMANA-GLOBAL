...
@ApiModel
public class TransactionVerifiedInfoResponse extends TransactionInfo {
    // additional fields
    ...
    public TransactionVerifiedInfoResponse() {
    }

    public TransactionVerifiedInfoResponse(TransactionDTO dto) {
        this(new TransactionInfo(dto));
    }
     ...
     */
    public TransactionVerifiedInfoResponse(TransactionInfo info) {
        this.type = info.type;
